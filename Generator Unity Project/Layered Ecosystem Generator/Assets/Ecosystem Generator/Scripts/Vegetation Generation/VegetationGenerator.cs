...
//    private void GrowStem(Vector3 growDirection, Vector3 startPosition, float startRadius, int currentSegment)
//    {
...
//        for (int i = stem.m_segmentsThrough; i < nCurveRes; i++)
//        {
...
//                //float declination = Mathf.Max(0, GetDeclination(growDirection));
//                //
//                //float splitAngle = (m_vegDesc.m_0SplitAngle + VegetationMetrics.GetVariation(m_vegDesc.m_0SplitAngleV)) - declination;
//                //growDirection = (Quaternion.Euler(0, 0, splitAngle) * growDirection).normalized;
//                //vegetationStems.Enqueue(new Stem(curPos, growDirection, stem.m_recursionLevel, i + 1));
//            }
//            else
//            {
//                // Normal split.
...
//    private float GetDeclination(Vector3 direction)
//    {
//        return Mathf.Rad2Deg * (Mathf.Atan2(Mathf.Sqrt(Mathf.Pow(direction.x, 2.0f) + Mathf.Pow(direction.y, 2)), direction.z));
//    }
